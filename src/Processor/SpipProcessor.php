...
class SpipProcessor extends AbstractFullProcessor
{
    ...
    protected function removeMenuTraductions(): void
    {
        ...
        $translationId = $this->easyMeta->propertyId($translationTerm);
    ...
    protected function cleanMenu(): void
    {
        ...
        if ($removedConcepts) {
            $itemIds = [];
            $curationCategoryId = $this->easyMeta->propertyId('curation:category');
    ...
    private function lienArticles(?ItemRepresentation $item): array
    {
        ...
        if (is_null($propertyId)) {
            $propertyId = $this->easyMeta->propertyId('curation:category');
        }
